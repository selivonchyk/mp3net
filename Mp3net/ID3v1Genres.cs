namespace Mp3net
{
	...
	{
		public static readonly string[] GENRES = new string[] { "Blues", "Classic Rock", 
			"Country", "Dance", "Disco", "Funk", "Grunge", "Hip-Hop", "Jazz", "Metal", "New Age"
			...
			, "Black Metal", "Crossover", "Contemporary Chr", "Christian Rock", "Merengue", 
